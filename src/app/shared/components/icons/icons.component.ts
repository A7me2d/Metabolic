...
// Fitness SVG Icons - Using proper SVG paths instead of emojis
@Component({
  selector: 'app-icon',
  standalone: true,
  template: '',
...
export class IconsComponent {
  // This is a base component - specific icons are used inline in templates
}

// Icon SVG paths for reuse
export const FITNESS_ICONS = {
  // Streak/Fire icon
  streak: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  muscle: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <path d="M3.5 12.5c1-2 3-3 5-3 4 0 6 4 10 4 2 0 3-1 3-2s-1-2-3-2c-4 0-6 4-10 4-2 0-4-1-5-3z"/>
    <path d="M20.5 12.5c-1 2-3 3-5 3-4 0-6-4-10-4-2 0-3 1-3 2s1 2 3 2c4 0 6-4 10-4 2 0 4 1 5 3z"/>
  </svg>`,
  ...
  // Rest icon
  rest: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <path d="M3 11l18-5v12L3 13V11z"/>
  ...
  // Barbell
  barbell: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <path d="M2 12h2"/>
    <path d="M20 12h2"/>
    <path d="M6 12h12"/>
    <path d="M4 8v8"/>
  ...
  // Reps
  reps: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <path d="M4 4h16v16H4z"/>
    <path d="M9 9h6v6H9z"/>
  </svg>`,
  
  // Sets
  sets: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
